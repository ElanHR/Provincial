...
private:
	...
	enum StateFeatures {
		...
		BUY_ACTION_CARD_ATTACK,
		BUY_ACTION_CARD_REACTION,
		...
		// playing cards
		PLAY_ACTION_CARD_WITH_EFFECT,
		PLAY_ACTION_CARD_TRASH_CARD,
		PLAY_ACTION_CARD_DISCARD_CARDS,
		PLAY_ACTION_CARD_ATTACK,
		PLAY_ACTION_CARD_REACTION,
		PLAY_ACTION_CARD_MORE_ACTIONS,
		PLAY_ACTION_CARD_MORE_CARDS,
		PLAY_ACTION_CARD_MORE_PLAYING_POWER,
		...
		BUY_CARD_SPY,
		BUY_CARD_THRONEROOM,
		BUY_FIRST_WITCH, BUY_FIRST_MOAT,
